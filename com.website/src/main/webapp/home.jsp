...
<body style="background-color: black;">
	...
	<div class="collapse" id="navbarToggleExternalContent">
		<div style="background-color: black;" class="p-4">
			...
			<span class="text-white d-inline">${user.userName.fname} <%=" "%>
				${user.userName.lname}<a href="logout" style="margin-left: 90%;"
				class="text-white d-inline">logout</a>
			</span>
		</div>
	</div>
	...
	<p class="text-light text-center" style="margin-top: 150px;">I
